...
function ContentMainUser(props) {
      ...
      try {
        if (token) {
          ...
          const res = await fetch(
            'https://localhost:7067/v1/api/Insurance',
            options,
          );
  ...
  return (
    <div className="d-flex home--user">
      <div className="d-flex sidebar flex-column flex-shrink-0 bg-dark">
        <ul className="nav home--user--navigator nav-pills flex-column mb-auto px-0 mt-4">
